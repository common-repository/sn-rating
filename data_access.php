...
class DataAccess {
  ...
  public function getRating($entity) {
    ...
    // Get count of total for current entity
    $total_count = $this->db->get_row("Select count(rating_score) as record_count from " . $this->db->prefix . "rating_scores where entity_content_id = '$id' AND entity_type_name = '$type'");
    ...
    return array(
        ...
        'count' => isset($total_count -> record_count) ? $total_count -> record_count : 0
    );
  }
