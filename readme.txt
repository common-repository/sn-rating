=== SN Rating ===
Contributors: Paritosh Gautam, Divesh Kumar, Ramanpreet Singh
Donate link: 
Tags: Rating, Demographic information, Rating by region, Rating by post, Rating by Page, Rating by post type, Rich Snippets, Rich Snippets Rating
...
1. Assign Rating Parameters
2. Change Rating Scale images
3. Multiset Rating Factors
4. Rating on blog listing
5. Rating on Post page
6. Multiset rating view
7. Most Rated Content
8. Share post (Facebook & Twitter)
9. Rating Widget (No multiset)
10. Rating Widget (Multiset)
11. Administer Rating entities
12. Multiset administration.
13. Edit Theme Link
14. Analytics & Sharing Configuration options.
15. Rating Scale
16. Rating Analytics
17. BuddyPressMedia - Detail View
18. BuddyPressMedia - Popup View
19. BuddyPressMedia - Activity View
...
= Using the Plugin =
[Installation Instruction](http://snrating.wordpress.com/2013/04/04/sn-rating-plugin-installation/) | 
[Configuration Instruction](http://snrating.wordpress.com/2013/04/05/sn-rating-plugin-configuration/)
...
= 1.5 =
* Support for google rich snippet for better presence in SEO.
* Plugin support for wordpress version 3.8.

= 1.4.6 =
* Plugin support for wordpress version 3.6.1

= 1.4.5 =
* Bug fix for rating box callback in BuddyPress pages.

= 1.4.4 =
* Rating for BuddyPress media/images and listing page
* Bug fix for parameter based rating

= 1.4.3 =
* Bug fix for path issue on mac/linux.

= 1.4.2 =
* Bug fix for CSS, Rating Analytics menu widget
* Improved UI for Rating Analytics page
* Destination change for download file (GeoLiteCity.dat) from 'plugins/sn-rating' to 'wp-content/themes/library'
* Multisite Support for the plugin

= 1.4.1 =
* Warning and Notices fixes
* Bug fix for delete rating parameters display on posts

= 1.4 =
* Added Rating Analytics Page
* Added Post wise rating scale configuration

= 1.3 =
* Bug fix for after upgrade data deletion and edit theme for custom post type 

= 1.2 =
* Bug fix for custom post types display in Rating Configuration tab

= 1.1 =
* Added copy deck changes
* Default enabled Edit Theme, Assign Rating Parameters links
* Removed default theme selection from Analytics & Sharing Configuration Tab
* Condition change for Rating Details widget display to administrator role only
...
= I have installed the plugin however the rating is still not visible on my content? =
...
= How to enable Multiset Rating Factors Mode? =
...
= After enabling Factors Mode where do I attach or use factors for posts? =
...
= What is Demographic Mode under Advanced Settings? =
...
We would appreciate your views and suggestions to make this plugin a success. Please mail us at diveshkumar1983@gmail.com or paritoshgautam@hotmail.com
